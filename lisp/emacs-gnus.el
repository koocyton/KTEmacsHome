...
;;服务器的设定
(setq gnus-select-method '(nntp "news.cn99.com"));;(nntp "news.yaako.com"))
(setq gnus-secondary-select-methods '((nntp "news.newsfan.net")(nnml "")))
...
;;_+ pop
(setq mail-source-primary-source '(pop :user "i_liuyi" :server "pop.163.com" :password "......" :port 110))
;;(setq mail-sources '(
...
(setq gnus-summary-show-article-charset-alist
	  '((1 . cn-gb-2312) (2 . big5) (3 . utf-8)))
(setq gnus-group-name-charset-method-alist
	  '(((nntp "news.newsfan.net") . cn-gb-2312)))
